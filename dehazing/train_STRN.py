...
scheduler = optim.lr_scheduler.StepLR(step_size=65, gamma=0.8, optimizer=optimizer)####step_size epoch
...
for epoch in range(start_epoch, opt.OPTIM.NUM_EPOCHS + 1):
    ...
    for i, data in enumerate(tqdm(train_loader), 0):
        ...
        loss = (0.2*loss_char) + (0.2*loss_edge) - (0.15*loss_SSIM)# + (0.3*loss_L1smooth)# 0.05,0.2
